          ...
          ScrollTrigger.create({
            ...
            onEnter: () => {
              if (!buttonClicked && !settingUp) {
                ...
                gsap.to(window, {
                  onStart: disableScroll,
                  scrollTo: { y: "#section10", autoKill: false },
                  overwrite: true,
                  duration: 1,
                });
                gsap.to('.js-img-3', { duration: 1, maxWidth: '44%', height: '100%', width: '44%', bottom: '0', delay: 1.5 });
                setTimeout(function () {
                  gsap.to(window, {
                    scrollTo: { y: "#section11", autoKill: false },
                    overwrite: true,
                    duration: 1,
                    onComplete: enableScroll,
                  });
          ...
          ScrollTrigger.create({
            ...
            onEnterBack: () => {
              ...
              if (!buttonClicked && !settingUp) {
                ...
                gsap.to('.js-img-3', { duration: 1, maxWidth: '100%', height: '100vh', width: '100vw', bottom: '100%' });
                setTimeout(function () {
                  gsap.to(window, {
                    scrollTo: { y: "#section9", autoKill: false },
                    overwrite: true,
